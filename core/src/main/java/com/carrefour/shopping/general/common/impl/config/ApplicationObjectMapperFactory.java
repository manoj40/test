package com.carrefour.shopping.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the carrefour-shopping-demo application.
 */
